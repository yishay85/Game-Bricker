...
public class BotBadEffect extends BotEffect {
     ...
     * @param gameManager
     */
    public BotBadEffect(Vector2 topLeftCorner, Vector2 dimensions, Renderable renderable,
                        GameObjectCollection gameObjectCollection, ImageReader imageReader, BrickerGameManager gameManager) {
    ...
    protected GameObject createBot(CreateObject createObject, ImageReader imageReader) {
        return createObject.createBotBadPaddle(imageReader);
    }
}
